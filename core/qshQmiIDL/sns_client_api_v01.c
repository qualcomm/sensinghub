...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6.3/sns_client_api/src/sns_client_api_v01.c#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.9 
   It was generated on: Tue Aug 19 2025 (Spin 0)
...
static const uint8_t sns_client_version_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_client_version_req_msg_v01, payload) - QMI_IDL_OFFSET8(sns_client_version_req_msg_v01, payload_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_client_version_req_msg_v01, payload),
  ((SNS_CLIENT_REQ_LEN_MAX_V01) & 0xFF), ((SNS_CLIENT_REQ_LEN_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(sns_client_version_req_msg_v01, payload) - QMI_IDL_OFFSET8(sns_client_version_req_msg_v01, payload_len)
};

static const uint8_t sns_client_version_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_client_version_resp_msg_v01, payload) - QMI_IDL_OFFSET8(sns_client_version_resp_msg_v01, payload_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_client_version_resp_msg_v01, payload),
  ((SNS_CLIENT_RESP_LEN_MAX_V01) & 0xFF), ((SNS_CLIENT_RESP_LEN_MAX_V01) >> 8),
  QMI_IDL_OFFSET8(sns_client_version_resp_msg_v01, payload) - QMI_IDL_OFFSET8(sns_client_version_resp_msg_v01, payload_len)
};
...
static const qmi_idl_message_table_entry SNS_CLIENT_SVC_message_table_v01[] = {
  ...
  {sizeof(sns_client_version_req_msg_v01), sns_client_version_req_msg_data_v01},
  {sizeof(sns_client_version_resp_msg_v01), sns_client_version_resp_msg_data_v01}
};
...
static const qmi_idl_service_message_table_entry SNS_CLIENT_SVC_service_command_messages_v01[] = {
  ...
  {SNS_CLIENT_VERSION_REQ_V01, QMI_IDL_TYPE16(0, 4), 1005}
};
...
static const qmi_idl_service_message_table_entry SNS_CLIENT_SVC_service_response_messages_v01[] = {
  ...
  {SNS_CLIENT_VERSION_RESP_V01, QMI_IDL_TYPE16(0, 5), 1005}
};
...
static const qmi_idl_service_message_table_entry SNS_CLIENT_SVC_service_indication_messages_v01[] = {
  ...
  {SNS_CLIENT_JUMBO_REPORT_IND_V01, QMI_IDL_TYPE16(0, 3), 10256}
};
