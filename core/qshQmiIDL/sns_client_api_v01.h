...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6.3/sns_client_api/api/sns_client_api_v01.h#4 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SNS_CLIENT_SVC_V01_IDL_MINOR_VERS 0x07
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SNS_CLIENT_SVC_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SNS_CLIENT_SVC_V01_MAX_MESSAGE_ID 0x0024
/**
    @}
  */
...
#define SNS_CLIENT_RESP_LEN_MAX_V01 1000
...
#define SNS_CLIENT_JUMBO_REPORT_LEN_MAX_V01 10240
/**
    @}
  */
...
/** @addtogroup SNS_CLIENT_SVC_qmi_messages
    @{
  */
/** Request Message; Send Version Request to sensor service. Version Response is sent by
    the sensor service in response to every Version Request. */
typedef struct {
  ...
  uint32_t payload_len;  /**< Must be set to # of elements in payload */
  uint8_t payload[SNS_CLIENT_REQ_LEN_MAX_V01];
  /**<   Protocol Buffer encoded version request message buffer;
  see 'sns_client_version_request_msg' from sns_client.proto for more 
  details */
}sns_client_version_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_CLIENT_SVC_qmi_messages
    @{
  */
/** Response Message; Send Version Request to sensor service. Version Response is sent by
    the sensor service in response to every Version Request. */
typedef struct {
  ...
  uint8_t payload_valid;  /**< Must be set to true if payload is being passed */
  uint32_t payload_len;  /**< Must be set to # of elements in payload */
  uint8_t payload[SNS_CLIENT_RESP_LEN_MAX_V01];
  /**<   Protocol Buffer encoded version response message buffer; 
  see 'sns_client_version_response_msg' from sns_client.proto for more 
  details */
}sns_client_version_resp_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_CLIENT_VERSION_V01
...
#define SNS_CLIENT_VERSION_REQ_V01 0x0024
#define SNS_CLIENT_VERSION_RESP_V01 0x0024
/**
    @}
  */
